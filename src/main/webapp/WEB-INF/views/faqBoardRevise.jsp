...
<html>
    ...
    <body>
    	...
    	<div class="title-box">
    		...
    		<input class="writing-title-box" value="${boardDetail.title}" placeholder="제목을 입력해 주세요">
    	</div>
    	
    	<div class="container" style="width: width: 100%; padding: 0 113px; margin: 30 0px;">	
 	 		<textarea class="summernote" name="editordata">${boardDetail.content}</textarea>
 ...
 <script src="./resources/js/faqBoardRevise.js"></script>
