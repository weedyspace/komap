...
<html>
  	<head>
  		<title>코맵 - 자주 묻는 질문 | komap.com</title>
  		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
		<link rel="stylesheet" type="text/css" href="./resources/css/home.css?ver=242323">  <!-- css링크 -->
...
/* 		.board-row:nth-child(1) > div {  //공지 줄 디자인  
			background: #D5D8DC;
		} */
	</style>	
    ...
    <body>
    	...
    	<div class="board-top-box">
    		<div class="board-box-inside">
    			<div class="inside-box-left">질문 및 답변</div>
    		...
    		<div class="board-box-row">
     			...
     			<div class="bigBox">
      			  	...
      			  	<%-- <c:forEach var="writing" items="${writingList}"> 
	     				<c:if test="${writing.id eq '관리자'}"> --%>
  				    		<div class="board-row">	
	    						<%-- <div class="col-md-1 top-header-add first"><span style="color:red;">공지</span></div>
	    			 			<div class="col-md-6 top-header-add"><span class="click-detail" data-board-index="${writing.board_idx}" style="font-weight:700;">${writing.title}</span></div>
	    			 			<div class="col-md-2 top-header-add"><span style="font-weight:700;">${writing.id}</span></div>
