...
<html>
  	<head>
  		<title>질문 및 답변 디테일</title>
  		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
		<link rel="stylesheet" type="text/css" href="./resources/css/home.css?ver=63545289393">  <!-- css링크 -->
     			...
     			<div class="board-top-box">
	    			<div class="board-box-inside" style="width:98%;">
	    				...
	    				<div class="inside-box-right">
	    		        	...
	    		        	<script src="./resources/js/faq.js"></script> <!-- ***이줄까지는 faq.js 가 적용되고 아래부터는 faqBoardDetail.js가 적용됨*** -->
	    				</div>
	    			</div>
    		    </div>
...
<%-- 		    <c:if test="${loginUser.id != boardDetail.id || empty loginUser}">
		        ...
		        <div class="reply-area">
		        	...
		        	<div class="reply-box">
		        		...
		        		<div class="main whole line-image"></div>
...
<!-- 		<div class="dropdown">
    ...
    <script src="./resources/js/faqBoardDetail.js"></script>
